...
const ServiceCard = ({color, title , icons , subtitle})=>(
  <div className='flex flex-row justify-start items-center white-glassmorphism  p-3 cursor-pointer hover:shadow-xl'>
...
const Services = () => {
  return (
    <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services '>
      ...
      <div className='flex flex-1 gap-3 flex-col justify-start items-center'>
        <ServiceCard 
        color = "bg-[#2952E3]"
